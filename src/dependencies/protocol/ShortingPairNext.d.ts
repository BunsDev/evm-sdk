...
interface ShortingPairNextInterface extends ethers.utils.Interface {
  functions: {
...
export class ShortingPairNext extends BaseContract {
  ...
  interface: ShortingPairNextInterface;
