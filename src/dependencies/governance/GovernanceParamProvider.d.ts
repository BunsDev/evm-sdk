...
interface GovernanceParamProviderInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernanceParamProvider extends Contract {
  ...
  interface: GovernanceParamProviderInterface;
